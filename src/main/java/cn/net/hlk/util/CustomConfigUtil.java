...
public class CustomConfigUtil  {
    ...
    private static ResourceBundle resourceBundleCustom = null;
	    ...
	    static {
            ...
            String source = resourceBundleActive.getString("custom.config.source");
            resourceBundleCustom = ResourceBundle.getBundle("config/"+source);
    ...
    public static String getString(String key) {
        ...
        } else if(resourceBundleCustom.containsKey(key)){
            return resourceBundleCustom.getString(key);
